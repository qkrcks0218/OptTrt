...
# "Sen_Training_1417.csv" and "Sen_Test_18.csv", respectively.
############################################
...
# Unzip the file and make the path as follows.
# Data/GPS_2018/
# Check 10 files including "SNGE81FL.shp" are in "Data/GPS_2018" folder.
##########################################
